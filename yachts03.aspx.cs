...
namespace tayanaBackend
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        private void getleft()
        {
            ...
            string sqlstring =
                @"SELECT  yachts.id, yachts.type, yachtsDetails.detailID, yachtsDetails.typeID, yachtsDetails.serial, yachtsDetails.date
...
FROM      yachts INNER JOIN
            ...
            if (id != 0)
            {
                if (reader.Read())
                {
                    ...
                    Label7.Text = reader["specification"].ToString();
